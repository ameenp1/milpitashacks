...
const GROUPS: QuestionGroup[] = [
  ...
  // Immediate-need / expedited-service screen (from the SAWS 2 PLUS application).
  // These are asked once and also drive the eligibility engine (lib/eligibility.ts).
  { id: "programs_applying", isCore: false, answerType: "text",
    question: "Which programs are you applying for? For example, Cash Aid, CalFresh food benefits, or Medi-Cal.",
    help: "Most people in a housing crisis apply for Cash Aid and CalFresh together." },
  { id: "food_3_days", isCore: false, answerType: "boolean", choices: ["Yes", "No"],
    question: "Will your food run out in 3 days or less?",
    help: "If yes, you may be able to get CalFresh food benefits within 3 days." },
  { id: "utilities_shutoff", isCore: false, answerType: "boolean", choices: ["Yes", "No"],
    question: "Have your utilities been shut off, or do you have a shut-off notice?",
    help: "A shut-off can qualify you for immediate help." },
  { id: "need_transport", isCore: false, answerType: "boolean", choices: ["Yes", "No"],
    question: "Do you need help with transportation to get food, clothing, medical care, or other emergency items?",
    help: "The county may be able to help with urgent needs." },
  { id: "essential_clothing", isCore: false, answerType: "boolean", choices: ["Yes", "No"],
    question: "Do you need essential clothing, such as diapers or clothing for cold weather?",
    help: "Urgent clothing needs can qualify you for extra help." },
  { id: "migrant_worker", isCore: false, answerType: "boolean", choices: ["Yes", "No"],
    question: "Is your household a migrant or seasonal farm worker household with $100 or less in resources?",
    help: "If yes, you may qualify for faster food benefits." },
  { id: "is_pregnant", isCore: false, answerType: "boolean", choices: ["Yes", "No"],
    question: "Is anyone in your household pregnant?",
    help: "Pregnancy can qualify you for additional or faster help." },
  { id: "personal_emergency", isCore: false, answerType: "boolean", choices: ["Yes", "No"],
    question: "Does anyone in your household have a personal emergency, such as a medical need, or domestic, child, or elder abuse?",
    help: "If yes, the county can help right away. If you are in danger, call 911." },
...
const FIELD_MAP: Record<string, Omit<Field, "token">[]> = {
  ...
  saws2plus: [
    ...
    { id: "phone", group: "phone", anchor: "WORK/ALTERNATE/MESSAGE PHONE", answerType: "phone" },
    { id: "email", group: "email", anchor: "EMAIL ADDRESS", answerType: "email" },
    // Immediate-need / expedited-service screen (page 1 of the application).
    { id: "programs", group: "programs_applying", anchor: "What programs are you applying for", answerType: "text" },
    { id: "food_3_days", group: "food_3_days", anchor: "Will your food run out in 3 days", answerType: "boolean" },
    { id: "utilities_shutoff", group: "utilities_shutoff", anchor: "Have your utilities been shut off", answerType: "boolean" },
    { id: "need_transport", group: "need_transport", anchor: "food, clothing, medical care or other emergency", answerType: "boolean" },
    { id: "essential_clothing", group: "essential_clothing", anchor: "Do you need essential clothing", answerType: "boolean" },
    { id: "migrant_worker", group: "migrant_worker", anchor: "migrant/seasonal farm worker household", answerType: "boolean" },
    { id: "is_pregnant", group: "is_pregnant", anchor: "Is anyone pregnant", answerType: "boolean" },
    { id: "personal_emergency", group: "personal_emergency", anchor: "Does anyone in your household have a personal emergency", answerType: "boolean" },
    { id: "eviction", group: "has_eviction_notice", anchor: "Do you have an eviction notice or a notice to pay rent", answerType: "boolean" },
    { id: "sign_date", group: "sign_date", anchor: "SIGNATURE OF APPLICANT", answerType: "date" },
  ],
